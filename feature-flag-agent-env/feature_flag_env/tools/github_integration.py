    ...
    def authenticate(self) -> ToolResponse:
        ...
        try:
            ...
            try:
                ...
                self.gh_repo = self.client.get_repo(f"{self.owner}/{self.repo_name}")
    ...
    def get_deployment_status(
        ...
        try:
            ...
            for deployment in deployments:
                ...
                latest_status_list = list(status_response[:1])
                latest_status = latest_status_list[0] if latest_status_list else None
